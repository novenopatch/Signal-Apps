...
public class MessageHelper {
    ...
    // -- UPDATE --
    public static Task<Void> updateUserLike(String uid, ArrayList<String> stringArrayList) {
        return   ChatHelper.getChatCollection().document(uid).update("IdStringArrayList", stringArrayList);
